...
export const TargetRangeLoadingOverlay: React.FC = () => {
    ...
    const interval = setInterval(() => {
      setProgress((prev) => {
        if (prev >= 100) {
          ...
          setTimeout(() => {
            setCurrentStep('tutorial-target-range')
          }, 500)
          return 100
        }
  ...
  return (
    <div className="loading-overlay">
      ...
      <div className="loading-overlay__title-container">
        <h2 className="loading-overlay__title">LOADING TARGET RANGE</h2>
        <p className="loading-overlay__description">
          Preparing target range mode...
        </p>
      </div>
