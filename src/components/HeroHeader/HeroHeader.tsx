...
interface HeroHeaderProps {
  ...
  onTeeOffClick?: (courseId: string) => void
}

export const HeroHeader: React.FC<HeroHeaderProps> = ({ featuredCourse, onTeeOffClick }) => {
  // Use video from public folder - account for Vite base path
  const basePath = import.meta.env.BASE_URL || '/'
  const videoPath = `${basePath}videos/hero-video.mp4`
