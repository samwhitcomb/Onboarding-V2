...
export const StatsBar: React.FC<StatsBarProps> = ({ course, stats }) => {
  ...
  // GIR tag logic
  const getGIRTag = (percentage: number) => {
    if (percentage < 45) {
  ...
  const getSegmentTooltip = (type: string) => {
              ...
              {showHandicapTooltip && (
                <div className="stat-tooltip handicap-tooltip">
                  ...
                  <div className="tooltip-content">
                    {Object.entries(stats.handicapTiers).map(([tier, score]: [string, any]) => (
