 ...
 * @param course - Course object with rating, yardage, type, etc.
 * @param version - 'standard' or 'studio' (default: 'studio' if isStudio, else 'standard')
 * @returns Stats object with all required metrics
 */
export function generateMockStats(course: any, version: string | null = null) {
